...
public class AdminService extends AbstractSeerService {
    ...
    public AdminService(DriverManagerDataSource dataSource, DriverManagerDataSource dataSourceCropwire, DriverManagerDataSource dataSourceCropwireData) {
        super(dataSource, dataSourceCropwire, dataSourceCropwireData);
    }
